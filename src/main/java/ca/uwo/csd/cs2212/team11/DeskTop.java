...
//		System.err.println("\t***Does nothing yet");
	...
	private void populateEastPanel(JPanel a){
		...
		Serialize r = new Serialize();
		usr.getDailyGoals().setGoalsArray((String[]) r.readObject("./src/main/resources/desktop/setGoals.xml").readObject());
		...
		button.addActionListener(new java.awt.event.ActionListener() {
             public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (result == JOptionPane.OK_OPTION) {
			         ...
			         r.writeObject(usr.getDailyGoals().getGoalsArray(), "./src/main/resources/desktop/setGoals.xml");
			...
			goalsListLabelStep= new JLabel(usr.getDailyGoals().getStepGoalStr());
			goalsListLabelStep.setForeground(new Color(255,255,255));
			goalsListLabelCal= new JLabel(usr.getDailyGoals().getCalGoalStr());
			goalsListLabelCal.setForeground(new Color(255,255,255));
			goalsListLabelDis= new JLabel(usr.getDailyGoals().getDistGoalStr());
